# modules/devlake/main.tf - Módulo DevLake (ARQUIVO LIMPO)
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        {
          name  = "DB_URL"
          value = "mysql://devlake:${var.db_password}@devlake-db.cw1e8ws22a34.us-east-1.rds.amazonaws.com:3306/devlake?charset=utf8mb4&parseTime=True&loc=UTC"
        },
        {
          name  = "LOGGING_DIR"
          value = "/app/logs"
